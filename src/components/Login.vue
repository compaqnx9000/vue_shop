  ...
  <div class="login_container">
    <div class="login_box">
      ...
      <div class="avatar_box">
        <img src="../assets/WX20190518-220208@2x.png" alt="" />
      </div>
      <el-form :rules="rules" :model="form" label-width="0px" class="login_form" ref="loginForm">
        <el-form-item prop="name">
          <el-input v-model="form.username" prefix-icon="el-icon-user-solid"></el-input>
        </el-form-item>
        <el-form-item prop="password">
          <el-input v-model="form.password" prefix-icon="el-icon-more" type="password"></el-input>
        </el-form-item>
...
.login_box {
  ...
  .avatar_box {
    ...
    border-radius: 50%;
    padding: 10px;
    box-shadow: 0 0 10px rgb(236, 221, 136);
    position: absolute;
    left: 50%;
    top: 0%;
    transform: translate(-50%, -50%);
